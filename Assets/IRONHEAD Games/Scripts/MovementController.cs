...
public class MovementController : MonoBehaviour
{
    ...
    {
        _teleportationProvider.endLocomotion += OnEndLocomotion;
    }
    ...
    void OnEndLocomotion(LocomotionSystem locomotionSystem)
    {
        ...
        MainVRPlayer.transform.position =
            MainVRPlayer.transform.TransformPoint(XRRigGameObject.transform.localPosition);
        XRRigGameObject.transform.position = Vector3.zero;
    }
